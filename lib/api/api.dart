...
class Networking {
  ...
  static fetchUserProfile() async {
    final url =
        "http://ios.zmzapi.com/index.php?accesskey=519f9cab85c8059d17544947k361a827&client=1&g=api/v3&m=index&a=login&account=popeyelau%40gmail.com&did=2A2B9DE8-5038-4FBE-8ECB-DD86D3301FB1&password=yy_demo123456&registration_id=141fe1da9efde137552";
    var response = await http.get(url);
    Map<String, dynamic> map = json.decode(response.body)["data"];
